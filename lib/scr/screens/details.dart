...
import 'package:foodorderingwithpayment/scr/models/products.dart';
      ...
      body: SafeArea(
        child: app.isLoading ? Loading() : Column(
          ...
          children: <Widget>[
            ...
            CustomText(text: "الوصف",size: 18,weight: FontWeight.w400),
            ...
            Row(
              ...
              children: <Widget>[
                ...
                GestureDetector(
                  onTap: ()async{
                    app.changeLoading();
                    print("تم تحميل كل المجموعات");

                   bool value =  await user.addToCard(product: widget.product, quantity: quantity);
                   if(value){
                     _key.currentState.showSnackBar(
                         SnackBar(content: Text("تمت الاضافة الى القائمة!"))
                     );
                     user.reloadUserModel();
                     app.changeLoading();
                     return;
                   } else{
                     print("لم يتم الاضافة للقائمة");
                   }
                  },
                  child: Container(
                    ...
                    child: app.isLoading ? Loading() : Padding(
                      ...
                      child: CustomText(text: " الي القائمة $quantity اضافة ",color: white,size: 22,weight: FontWeight.w300,),
                    ),
                  ),
                ),
                Padding(
