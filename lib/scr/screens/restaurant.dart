...
import 'package:foodorderingwithpayment/scr/models/restaurant.dart';
...
import 'package:foodorderingwithpayment/scr/widgets/small_floating_button.dart';
              ...
              Stack(
                children: <Widget>[
                  ...
                  Positioned.fill(
                      ...
                      child: Align(
                          alignment: Alignment.bottomCenter,
                          child: CustomText(text:"\$"+restaurantModel.avgPrice.toString()+" متوسط السعر ", color: white, size: 18, weight: FontWeight.w300,))),
...
//              open & book section
              Row(
                ...
                children: <Widget>[
                  CustomText(text: "فتح", color: green, weight: FontWeight.w400, size: 18,),
                  Container(
